...
```{r defineFragmentFunction ,echo=FALSE}
...
save(redundantBlib,"redundant.Rdata")
save(nonRedundantBlib,"nonredundant.Rdata")
...
```{r annotateDatabases,eval=FALSE}
...
load("redundant.Rdata")
load("nonredundant.Rdata")
